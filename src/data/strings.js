...
export const T = {
  ...
  activateStep1a: { en: 'Get the login from your teacher.', es: 'Pida el acceso a la maestra.' },
  activateStep1b: {
    en: 'Ask for your child’s IXL username and password.',
    es: 'Solicite el usuario y la contraseña de IXL de su hijo.',
  },
  ...
  activateCompact: {
    en: 'Ask your teacher for the IXL login — your child must sign in to activate it. No cost to families.',
    es: 'Pida a la maestra el acceso de IXL — su hijo debe iniciar sesión para activarlo. Sin costo para las familias.',
  },
  ...
  otherWeek: { en: 'Another week', es: 'Otra semana' },
